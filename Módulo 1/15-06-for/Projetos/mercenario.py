...
class Mercenary(Player):
    def __init__(self, part1="", part2="", part3="", part4="", part5="", part6="", choice1="", choice2="", choice3="", choice4="", choice5=""):
        ...
        super().__init__(part1, part2, part3, part4, part5,
                         part6, choice1, choice2, choice3, choice4, choice5)
    ...
    def choices_History1(self, choice):
        try:
            ...
            if choice == 1:
                choice = list()
                choice.extend(
                    ["Brandom tem sua cabeça dilacerada pelos demônios!", 6])
                return choice
            elif choice == 2:
                choice = list()
                choice.extend(["", 2])
    ...
    def choices_History2(self, choice):
        try:
            ...
            if choice == 1:
                choice = list()
                choice.extend(
                    ["Após se livrar da primeira leva de demônios ele acaba levando um \ngolpe fatal em seu peito por um demônio que não havia sido acertado \npelo água benta.", 6])
                return choice
            elif choice == 2:
                choice = list()
                choice.extend(
                    ["Após deferir alguns golpes, um demonio acerta sua cabeça e ele morre.", 6])
                return choice
            else:
                choice = list()
                choice.extend(["", 3])
    ...
    def choices_History3(self, choice):
        try:
            ...
            if choice == 1:
                ...
                choice = list()
                choice.extend(
                    ["A água benta que usou não foi suficiente para matar todos os demônios.", 6])
                return choice
            else:
                choice = list()
                choice.extend(
                    ["O carro não consegue passar pelos demônios e ele acaba tendo que sair, \nele é atingido por diversos golpes e morre lentamente.", 6])
                return choice
        except:
            return self
    ...
    def choices_History4(self, choice):
        try:
            ...
            if choice == 1:
                ...
                choice = list()
                choice.extend(
                    ["Tem seu corpo consumido rapidamente pelos demônios.", 6])
                return choice
            else:
                choice = list()
                choice.extend(
                    ["O carro é invadido pelos demônios e sua morte é dolorosa de sofrida.", 6])
                return choice
        except:
            return self
    ...
    def choices_History5(self, choice):
        try:
            ...
            if choice == 1:
                choice = list()
                choice.extend(
                    ["O demonio retirar o coração de Brandon rapidamente.", 6])
                return choice
            elif choice == 2:
                choice = list()
                choice.extend(
                    ["O demônio é muito mais forte que Brandon e arraca todos os seus orgãos.", 6])
                return choice
            else:
                choice = list()
                choice.extend(
                    ["Brandon é cercado pelos demônios e morre tetando fugir.", 6])
                return choice
        except:
            return self
